    ...
    <main className="mx-auto flex min-h-screen max-w-6xl items-center px-6 py-12 text-slate-100 sm:px-10 lg:px-12">
      <div className="grid w-full gap-8 lg:grid-cols-[1fr_0.95fr]">
        <section className="flex flex-col justify-center">
          <p className="text-sm font-medium uppercase tracking-[0.3em] text-cyan-300">Login</p>
          <h1 className="mt-3 text-5xl font-semibold text-white">Return to your architecture workspace.</h1>
