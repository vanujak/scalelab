  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-6 py-12 text-slate-100 sm:px-10 lg:px-12">
      <header className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="text-sm font-medium uppercase tracking-[0.3em] text-cyan-300">Systems</p>
          <h1 className="mt-2 text-4xl font-semibold text-white">Architecture catalog</h1>
