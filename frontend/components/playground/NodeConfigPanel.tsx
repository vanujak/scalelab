    ...
    <div className="flex flex-col p-4 gap-5 overflow-y-auto">
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs text-slate-600">#{node.id.slice(-4)}</span>
        </div>
        <input
          value={label}
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-slate-600">
                    {edge.source === node.id ? "→ outbound" : "← inbound"}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <label className="text-xs text-slate-500 whitespace-nowrap">Latency (ms):</label>
                  <input
                    type="number"
                    ...
                    className="w-full rounded-lg border border-white/10 bg-white/5 px-2 py-1 text-xs text-white outline-none focus:border-cyan-500/50"
                  />
                </div>
              </div>
            ))}
      ...
      <div className="mt-auto pt-4 border-t border-white/5 space-y-2">
        <button
          ...
          className="w-full rounded-xl border border-cyan-500/20 bg-cyan-500/5 px-4 py-2.5 text-sm font-medium text-cyan-400 transition hover:bg-cyan-500/10"
        >
        ...
        <button
          ...
          className="w-full rounded-xl border border-rose-500/20 bg-rose-500/5 px-4 py-2.5 text-sm font-medium text-rose-400 transition hover:bg-rose-500/10"
        >
          <span className="flex items-center justify-center gap-2">
            <svg
              className="h-4 w-4"
